...
class BillingImpl @Inject constructor(
    ...
    private val _products: MutableStateFlow<List<ProductDetails>> = MutableStateFlow<List<ProductDetails>>(emptyList())
    override val products: StateFlow<List<ProductDetails>>
        get() = _products
    private val _billingEvents: MutableSharedFlow<BillingEvent> = MutableSharedFlow(extraBufferCapacity = 1)
