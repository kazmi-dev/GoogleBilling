...
import com.kazmi.dev.coding.base.billing.billingWithDI.Product
import com.kazmi.dev.coding.base.billing.billingWithDI.ProductType
...
object BillingUtil: PurchasesUpdatedListener {
    ...
    private val products = listOf(Product(productId = "android.test.purchased", productType = ProductType.IN_APP.type))
    ...
    /** Get Products on Successful Connection*/
    fun setOnGetProductsListener(onGetProducts: (List<ProductDetails>) -> Unit) { this.onGetProducts = onGetProducts }
    /** Get Purchase callback on successful purchase*/
    fun setOnProductPurchasedListener(onProductPurchased: (purchaseId: String) -> Unit) { this.onProductPurchased = onProductPurchased }
